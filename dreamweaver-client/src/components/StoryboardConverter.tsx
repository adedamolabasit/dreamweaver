...
const StoryboardConverter = ({
  ...
  // Set the last journal as active by default
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    return () => clearInterval(intervalId); // Cleanup on unmount or when isGeneratingStory changes
  ...
  useEffect(() => {
    ...
    // Update your progress text state here
    // For example: setProgressText(progressText);
  ...
  return (
    <div className="flex flex-col items-center max-w-4xl mx-auto">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        {/* Journals Column - Now more prominent */}
            ...
            <div className="p-6 rounded-2xl bg-purple-900/20 backdrop-blur-sm border border-purple-500/10">
              ...
              {isGeneratingStory ? (
                ...
                <>
                  ...
                  {storyGenerated && (
                    <button
                      className="w-full py-3 rounded-lg bg-blue-600/80 hover:bg-blue-500/90 transition-colors font-medium mt-3 shadow-md"
        ...
        <div className="w-full p-6 rounded-2xl bg-purple-950/50 border border-purple-500/30 animate-fadeIn mb-8">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-lg font-medium text-purple-200">
              Editing: {moment(activeJournal.createdAt).format("MMMM D, YYYY")}
            </h4>
